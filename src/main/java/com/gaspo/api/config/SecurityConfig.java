    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return  httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/funcionarios/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/funcionarios/cadastro").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/funcionarios/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.GET, "/api/profissionais/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/profissionais/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.PUT, "/api/profissionais/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.DELETE, "/api/profissionais/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.GET, "/api/unidades-saude/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/unidades-saude/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.PUT, "/api/unidades-saude/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.DELETE, "/api/unidades-saude/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.GET, "/api/avisos/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/avisos/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.PUT, "/api/avisos/**").hasRole("FUNCIONARIO")
                        .requestMatchers(HttpMethod.DELETE, "/api/avisos/**").hasRole("FUNCIONARIO")
